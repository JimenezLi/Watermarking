...
if __name__ == '__main__':
    ...
    for watermark_index, watermark in enumerate(watermark_list):
        watermarking.E_FIXED_LC(single_image, 0, watermark=watermark, notes=watermark_index, output_path=test_cache_path)
        watermarking.E_FIXED_LC(single_image, 1, watermark=watermark, notes=watermark_index, output_path=test_cache_path)
        watermarking.E_FIXED_LC(single_image, -1, watermark=watermark, notes=watermark_index, output_path=test_cache_path)
